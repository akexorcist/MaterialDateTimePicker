 ...
 */
public class SupportTimePickerDialog extends DialogFragment implements
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(SupportTimePickerDialog view, int hourOfDay, int minute, int second);
    }

    public SupportTimePickerDialog() {
    ...
    public static SupportTimePickerDialog newInstance(OnTimeSetListener callback,
                                                      int hourOfDay, int minute, int second, boolean is24HourMode) {
        SupportTimePickerDialog ret = new SupportTimePickerDialog();
    ...
    public static SupportTimePickerDialog newInstance(OnTimeSetListener callback,
        ...
        return SupportTimePickerDialog.newInstance(callback, hourOfDay, minute, 0, is24HourMode);
    }
    ...
    public static SupportTimePickerDialog newInstance(OnTimeSetListener callback, boolean is24HourMode) {
        Calendar now = Calendar.getInstance();
        return SupportTimePickerDialog.newInstance(callback, now.get(Calendar.HOUR_OF_DAY), now.get(Calendar.MINUTE), is24HourMode);
    }
     ...
     * {@link SupportTimePickerDialog#setSelectableTimes(Timepoint[])}
     ...
     * This is a convenience wrapper around {@link SupportTimePickerDialog#setSelectableTimes(Timepoint[])}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mIs24HourMode) {
            ...
            if (mVersion == TimePickerDialog.Version.VERSION_2) {
